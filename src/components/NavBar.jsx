            ...
            <ul className="grid grid-cols-3 gap-4 sm:gap-0">
                <li className="flex justify-center items-center">
                    <Link href="/" onClick={() => handleLinkClick('/')}>
                        <span className={`inline-flex flex-col items-center justify-center px-8 py-2 ${activeLink === '/' ? 'text-blue-600' : 'text-gray-300'} hover:bg-gray-50 dark:hover:bg-gray-800 group`}>
